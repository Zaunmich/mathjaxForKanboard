...
// Original file found under App\Core\Markdown.php

namespace Kanboard\Plugin\mathjaxForKanboard\Helper;

// use Parsedown;
use Kanboard\Plugin\mathjaxForKanboard\Helper\MathJaxMarkdown;
 ...
 */
class CoreMarkdown extends MathJaxMarkdown
{
    /**
