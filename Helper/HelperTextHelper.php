...
// // Original file found under App\Helper\TextHelper.php

// namespace Kanboard\Helper;
namespace Kanboard\Plugin\mathjaxForKanboard\Helper;

// use Kanboard\Core\Markdown;
use Kanboard\Plugin\mathjaxForKanboard\Helper\CoreMarkdown;
 ...
 */
class HelperTextHelper extends Base
{
    /**
     * HTML escaping
     *
    ...
    {
        $parser = new CoreMarkdown($this->container, $isPublicLink);
